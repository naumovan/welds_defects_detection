...
class Yolov8OpenvinoDetectionModel(DetectionModel):
    ...
    def perform_inference(self, image: np.ndarray):
        ...
        self.infer_queue.start_async({self.input_layer_ir.any_name: self.input_tensor},
                                     (self.input_tensor, time.time()))
...
def load_openvino_sahi(
    ...
    return Yolov8OpenvinoDetectionModel(
